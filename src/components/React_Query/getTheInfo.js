        ...
        fromChainInfo: {
          ...
          trnx:
            item?.fromChain === 'BSC'
              ...
              : item?.fromChain === 'AVAX'
              ? `https://testnet.snowtrace.io/tx/${item?.fromTransactionHash}`
              : item?.fromChain === 'FTM'
              ? `https://testnet.ftmscan.com/tx/${item?.fromTransactionHash}`
              : item?.fromChain === 'MAT' || item?.fromChain === 'MATIC'
              ? `https://mumbai.polygonscan.com/tx/${item?.fromTransactionHash}`
              : 'javascript:void(0)',
        },
        toChainInfo: {
          image:
          ...
          trnx:
            item?.toChain === 'BSC'
              ...
              : item?.toChain === 'AVAX'
              ? `https://testnet.snowtrace.io/tx/${item?.toTransactionHash}`
              : item?.toChain === 'FTM'
              ? `https://testnet.ftmscan.com/tx/${item?.toTransactionHash}`
              : item?.toChain === 'MAT' || item?.toChain === 'MATIC'
              ? `https://mumbai.polygonscan.com/tx/${item?.toTransactionHash}`
              : 'javascript:void(0)',
            isSuccess:
